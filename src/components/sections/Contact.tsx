          ...
          >
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-slate-100">
                Let&apos;s build products used by millions
              </h3>

              <p className="text-slate-400">
                Currently exploring full-time Software Engineering opportunities
                in backend and full-stack development at product-driven
                companies. Feel free to reach out through the form or via email
                to connect.
              </p>
            </div>

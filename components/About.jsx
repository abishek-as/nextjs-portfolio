...
const infoData = [
  ...
  },
  {
    ...
    text: "abishek.codes@outlook.com",
  },
  {
                ...
                <TabsContent value="personal">
                  <div className="text-center xl:text-left">
                    <h3 className="h3 mb-4">
                      Dynamic software engineer driven by innovation and
                      excellence.
                    </h3>
                    <p className="subtitle max-w-xl max-auto xl:mx-0">
                      I excel in developing intuitive, full-stack websites using
                ...
                <TabsContent value="skills">
                  <div className="text-center xl:text-left">
                    <h3 className="h3 mb-7">
                      Tools I Use Everyday <br /> Languages, Libraries,
                      Databases, Dev Tools
                    </h3>
                    {/* skills  */}
                    <div className="mb-16">
